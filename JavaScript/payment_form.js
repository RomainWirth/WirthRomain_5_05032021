...
// ====== TEST ==================================================================================
console.log("test n°15 : vérification de la sélection du bon élément du DOM");
console.log(paymentFormButton); // vérification de la sélection du bouton dans la console
// == FIN TEST ==================================================================================

// infos sur les tests : 
console.log("tests de 16 à 25 : s'affichent à la console quand on désactive le lien vers la page confirmation de paiement (ligne 254) + clieck du bouton \"payer\"");
...
paymentFormButton.addEventListener ("click", function(event) { 
    ...
    // ====== TEST ==================================================================================
    console.log("test n°16 : page panier.html - affichage du contenu du tableau contact"); 
    ...
    console.log("série de tests n°17 : vérification de la validité des données du formulaire");
    ...
    if(firstNameControl() && lastNameControl() && cityControl() && addressControl() && emailControl()){
        ...
        // ====== TEST ==================================================================================
        console.log("test n°18 : vérification des infos du localStorage")
        ...
        // ====== TEST ==================================================================================
        console.log("test n°19 : page panier.html - contenu du tableau products (items Ids) et type de valeurs")
        ...
        // ====== TEST ==================================================================================
        console.log("text n°20 : vérification des données à envoyer au serveur");
        console.log(toSend);
        // == FIN TEST ==================================================================================
        ...
        // ====== TEST ==================================================================================
        console.log("text n°21 : contrôle de promiseSend envoyé au serveur");
        ...
        promiseSend.then(async function(response){
            try {
                // ====== TEST ==================================================================================
                console.log("test n°22 : vérification de la réponse du serveur");
                ...
                // ====== TEST ==================================================================================
                console.log("test n°23 : vérification du contenu de la réponse du serveur");
                console.log(content); // réponse serveur objets contact, products et orderId
                // == FIN TEST ==================================================================================

                if (response.ok){
                    // ====== TEST ==================================================================================
                    console.log("test n°24 : vérification de l'état de la réponse du serveur (true ou fasle)")
                    console.log(`résultat de response.ok : ${response.ok}`); // réponse true : 
                    // == FIN TEST ==================================================================================
                    
                    // récupération de l'id de la réponse du serveur
                    // ====== TEST ==================================================================================
                    console.log("test n°25 : affichage de l'id de response = utilisé pour la confirmation de commande");
...
// ====== TEST ==================================================================================
console.log("test n°26 : affichage des infos \"contact\" dans la variable contactData");
